...
class TestListDetectorsHappyPath:
    ...
    def test_list_all_detectors(self, project_facts_with_detectors):
    ...
    def test_list_detectors_with_name_filter(self, project_facts_with_detectors):
        """Test listing detectors with name filter."""
        request = ListDetectorsRequest(name_filter="reentrancy")
        response = list_detectors(request, project_facts_with_detectors)
    ...
    def test_list_detectors_with_description_filter(self, project_facts_with_detectors):
        """Test listing detectors filtering by description."""
        request = ListDetectorsRequest(name_filter="naming")
        response = list_detectors(request, project_facts_with_detectors)
    ...
    def test_detector_metadata_fields(self, project_facts_with_detectors):
        """Test that detector metadata contains all expected fields."""
        request = ListDetectorsRequest(name_filter="reentrancy-eth")
        response = list_detectors(request, project_facts_with_detectors)
...
class TestListDetectorsEdgeCases:
    ...
    def test_list_detectors_with_no_matches(self, project_facts_with_detectors):
        """Test listing detectors with filter that matches nothing."""
        request = ListDetectorsRequest(name_filter="nonexistent-detector")
        response = list_detectors(request, project_facts_with_detectors)
    ...
    def test_list_detectors_empty_project(self, empty_project_facts):
    ...
    def test_list_detectors_case_insensitive_filter(self, project_facts_with_detectors):
    ...
    def test_list_detectors_partial_match(self, project_facts_with_detectors):
        """Test that filter matches partial strings."""
        request = ListDetectorsRequest(name_filter="storage")
        response = list_detectors(request, project_facts_with_detectors)
