...
class TestListContractsHappyPath:
    ...
    def test_list_all_contracts(self, project_facts):
    ...
    def test_list_concrete_contracts(self, project_facts):
        """Test listing only concrete (non-abstract, non-interface, non-library) contracts."""
        request = ListContractsRequest(filter_type="concrete")
        response = list_contracts(request, project_facts)
    ...
    def test_list_interface_contracts(self, project_facts):
        """Test listing only interface contracts."""
        request = ListContractsRequest(filter_type="interface")
        response = list_contracts(request, project_facts)
    ...
    def test_list_library_contracts(self, project_facts):
        """Test listing only library contracts."""
        request = ListContractsRequest(filter_type="library")
        response = list_contracts(request, project_facts)
    ...
    def test_list_abstract_contracts(self, project_facts):
        """Test listing only abstract contracts."""
        request = ListContractsRequest(filter_type="abstract")
        response = list_contracts(request, project_facts)
    ...
    def test_contract_info_completeness(self, project_facts):
...
class TestListContractsEdgeCases:
    ...
    def test_empty_project_with_filter(self, empty_project_facts):
    ...
    def test_filter_with_no_matches(self, project_facts):
    ...
    def test_default_filter_type(self, project_facts):
    ...
    def test_contract_properties_accuracy(self, project_facts):
