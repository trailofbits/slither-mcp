...
class TestRunDetectorsHappyPath:
    ...
    def test_run_all_detectors(self, project_facts_with_detectors):
    ...
    def test_run_detectors_by_name(self, project_facts_with_detectors):
        """Test running specific detectors by name."""
        request = RunDetectorsRequest(detector_names=["reentrancy-eth"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_run_multiple_detectors_by_name(self, project_facts_with_detectors):
    ...
    def test_filter_by_impact_high(self, project_facts_with_detectors):
        """Test filtering results by high impact."""
        request = RunDetectorsRequest(impact=["High"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_filter_by_impact_informational(self, project_facts_with_detectors):
        """Test filtering results by informational impact."""
        request = RunDetectorsRequest(impact=["Informational"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_filter_by_multiple_impacts(self, project_facts_with_detectors):
        """Test filtering by multiple impact levels."""
        request = RunDetectorsRequest(impact=["High", "Informational"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_filter_by_confidence_high(self, project_facts_with_detectors):
        """Test filtering results by high confidence."""
        request = RunDetectorsRequest(confidence=["High"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_filter_by_confidence_medium(self, project_facts_with_detectors):
        """Test filtering results by medium confidence."""
        request = RunDetectorsRequest(confidence=["Medium"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_combined_filters(self, project_facts_with_detectors):
    ...
    def test_result_contains_source_locations(self, project_facts_with_detectors):
    ...
    def test_result_contains_description(self, project_facts_with_detectors):
        """Test that results include detailed descriptions."""
        request = RunDetectorsRequest(detector_names=["uninitialized-storage"])
        response = run_detectors(request, project_facts_with_detectors)
...
class TestRunDetectorsEdgeCases:
    ...
    def test_run_detectors_nonexistent_name(self, project_facts_with_detectors):
        """Test running a detector that doesn't exist."""
        request = RunDetectorsRequest(detector_names=["nonexistent-detector"])
        response = run_detectors(request, project_facts_with_detectors)
    ...
    def test_run_detectors_empty_project(self, empty_project_facts):
    ...
    def test_run_detectors_case_insensitive_name(self, project_facts_with_detectors):
    ...
    def test_run_detectors_case_insensitive_impact(self, project_facts_with_detectors):
    ...
    def test_run_detectors_case_insensitive_confidence(self, project_facts_with_detectors):
    ...
    def test_filter_excludes_all_results(self, project_facts_with_detectors):
    ...
    def test_multiple_results_from_same_detector(self, project_facts_with_detectors):
        """Test that multiple results from same detector are all returned."""
        request = RunDetectorsRequest(detector_names=["naming-convention"])
        response = run_detectors(request, project_facts_with_detectors)
