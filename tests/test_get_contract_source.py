...
class TestGetContractSourceHappyPath:
    ...
    def test_get_base_contract_source(self, project_facts, base_contract_key):
...
"""
        request = GetContractSourceRequest(contract_key=base_contract_key)
    ...
    def test_get_child_contract_source(self, project_facts, child_contract_key):
...
"""
        request = GetContractSourceRequest(contract_key=child_contract_key)
    ...
    def test_get_interface_source(self, project_facts, interface_a_key):
...
"""
        request = GetContractSourceRequest(contract_key=interface_a_key)
    ...
    def test_get_library_source(self, project_facts, library_b_key):
...
"""
        request = GetContractSourceRequest(contract_key=library_b_key)
    ...
    def test_source_with_multiple_contracts(self, project_facts, base_contract_key):
...
"""
    ...
    def test_empty_source_file(self, project_facts, empty_contract_key):
        """Test getting source code from an empty file."""
        mock_source = ""
        request = GetContractSourceRequest(contract_key=empty_contract_key)
...
class TestGetContractSourceEdgeCases:
    ...
    def test_nonexistent_contract(self, project_facts):
    ...
    def test_unicode_in_source(self, project_facts, base_contract_key):
...
"""
    ...
    def test_very_large_source_file(self, project_facts, base_contract_key):
    ...
    def test_source_with_special_characters(self, project_facts, base_contract_key):
...
class TestGetContractSourceFilePathHandling:
    ...
    def test_absolute_path_in_contract(self, project_facts, base_contract_key):
    ...
    def test_relative_path_in_contract(self, project_facts, child_contract_key):
