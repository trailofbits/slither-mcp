...
class TestGetDerivedContractsHappyPath:
    ...
    def test_no_derivation(self, test_path, project_facts, grandchild_contract_key):
        """Test getting derived contracts for a contract with no children."""
        # GrandchildContract should have no derivatives
        request = GetDerivedContractsRequest(path=test_path, contract_key=grandchild_contract_key)
        response = get_derived_contracts(request, project_facts)
    ...
    def test_interface_derivation(self, test_path, project_facts, interface_a_key):
        """Test getting derived contracts for an interface."""
        request = GetDerivedContractsRequest(path=test_path, contract_key=interface_a_key)
        response = get_derived_contracts(request, project_facts)
    ...
    def test_library_derivation(self, test_path, project_facts, library_b_key):
        """Test getting derived contracts for a library."""
        request = GetDerivedContractsRequest(path=test_path, contract_key=library_b_key)
        response = get_derived_contracts(request, project_facts)
...
class TestGetDerivedContractsEdgeCases:
    ...
    def test_circular_dependency_prevention(self, test_path, project_facts):
        ...
        request = GetDerivedContractsRequest(path=test_path, contract_key=contract_a_key)
    ...
    def test_self_referencing_contract(self, test_path, project_facts):
        ...
        request = GetDerivedContractsRequest(path=test_path, contract_key=self_ref_key)
    ...
    def test_empty_contract_derivation(self, test_path, project_facts, empty_contract_key):
        """Test getting derivation for empty contract (no functions but valid)."""
        request = GetDerivedContractsRequest(path=test_path, contract_key=empty_contract_key)
        response = get_derived_contracts(request, project_facts)
...
class TestBuildDerivedTree:
    ...
    def test_no_children(self, test_path, project_facts, grandchild_contract_key):
